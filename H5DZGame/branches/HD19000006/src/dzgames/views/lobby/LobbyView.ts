...
import SohaLobbyView from "../../../games/soha/views/SohaLobby";
import { sohares } from "../../../games/soha/confs/res";
...
export default class LobbyView extends ui.dzgame.GameLobby.LobbyUI {
    ...
    onClick():void{
        dzapp.Net.enterGame("query","ddz_match");
    }
 
    onClickSoha():void{
        dzapp.openGame(new SohaLobbyView(), sohares.lobby);
        dzapp.Net.enterGame("query","soha");
    }
}