...
import BaseView from "../../components/dzpage/BaseView";
import BaseDialog from "../../components/dzpage/BaseDailog";
/**
 * @description 事件监听与派发
 * @author wenzuoli
 * @date: 04/18/2019
...
export default class EventDispatch{
    ...
    public Listen(roomId:number,type:string,caller:any,listener:Function):void{
        let _allow:boolean = caller instanceof BaseScene||caller instanceof BaseView||caller instanceof BaseDialog;
        if(!caller||!_allow){
